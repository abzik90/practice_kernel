...
wait_queue_head_t wqd;
// DECLARE_WAIT_QUEUE_HEAD(wqd);
...
static int wait_function(void *unused){
    while(1){
        ...
        wait_event_interruptible(wqd, wait_queue_flag != 0);
...
MODULE_DESCRIPTION("Simple linux device driver with a Waitqueue");
